...
\begin{itemize}
    \item \textbf{\textit{PostgreSQL} com \textit{Supabase}:} O PostgreSQL foi adotado pela sua fiabilidade relacional e suporte nativo a transações ACID complexas. A plataforma \textit{Supabase} simplificou a infraestrutura ao disponibilizar o SGBD PostgreSQL em nuvem, juntamente com buckets compatíveis com S3 para ficheiros de recolha e autenticação integrada de utilizadores.
