...
\begin{itemize}
    \item \textbf{Testes em Ambiente Real:} Verificação da comunicação através de portas de comunicação série (RS-232) e validação da usabilidade do terminal quiosque táctil sob condições reais de armazém.
\end{itemize}
...
A verificação abrangeu três vertentes:
\begin{itemize}
    \item \textbf{Testes de Comunicação Série:} validação da receção de dados de peso a partir da balança industrial via porta RS-232;
