...
Durante as fases de desenvolvimento e testes de validação com a equipa da empresa, o website institucional foi alojado na plataforma Vercel, com compilação e publicação contínua (\textit{Continuous Deployment}). A arquitetura foi concebida para permitir a transição simplificada para o domínio e servidores corporativos permanentes da empresa.
