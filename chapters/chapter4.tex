...
\begin{itemize}
    ...
    \item \textbf{Contactos:} Disponibiliza um canal de envio de mensagens com validação de dados e a integração de um mapa interativo para localização física das instalações da empresa.
...
\begin{itemize}
    ...
    \item \textbf{Pedidos de Recolha:} Permite a submissão de solicitações de recolha mediante um formulário onde o cliente indica os materiais de resíduos que deseja recolher, dados de contacto e anexa documentos ou fotografias de suporte. Disponibiliza ainda a consulta, cancelamento e reativação de pedidos em curso.
