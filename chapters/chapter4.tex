...
\begin{enumerate}
    \item \textbf{Fluxo de Submissão e Triagem de Pedidos de Recolha:} O cliente acede à área reservada do website e submete um formulário indicando o material a recolher, e anexa fotografias. O pedido entra na base de dados com o estado \textit{Pendente}. O operador, na app de Backoffice, recebe o alerta, analisa os dados e as fotos    \item \textbf{Fluxo de Pesagem e Integração Física:} No armazém, o motorista descarrega os resíduos. O operador no terminal de pesagem (Kiosk) escolhe a recolha ativa. O operador insere o valor do peso medido no terminal, que submete os dados à API central. A pesagem é associada ao pedido de recolha original, o que atualiza a conta corrente do cliente.
...
\begin{itemize}
    ...
    \item \textbf{Histórico de Recolhas:} Regista os eventos logísticos concluídos e agendados. Apresenta o peso líquido total registado na balança física e a respetiva codificação legal (Lista Europeia de Resíduos), permitindo a exportação de dados em formatos como PDF e tabelas CSV.
